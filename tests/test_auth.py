...
from lineage_syncer.commons.exceptions import AuthenticationError
from lineage_syncer.commons.settings import Settings
from lineage_syncer.services.auth import (
    PBI_SCOPE,
...
def test_get_databricks_client_returns_client(settings: Settings) -> None:
    ...
    with patch("lineage_syncer.services.auth.WorkspaceClient") as mock_ws_cls:
